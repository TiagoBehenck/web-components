class StarRater extends HTMLElement { 
  ...
  build() { 
    ...
    const numberOfStart = this.getAttribute('data-number-of-star')

    this.stars = this.createStars(numberOfStart)
  ...
  createStars(numberOfStart){ 
    ...
    return Array.from({ length: numberOfStart || 5 }, createStar)
  }
